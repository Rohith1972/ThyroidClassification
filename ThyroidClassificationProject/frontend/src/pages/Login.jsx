        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50 relative overflow-hidden font-sans">
            ...
            >
                <div className="text-center">
                    <div className="inline-flex p-4 bg-white rounded-2xl shadow-premium border border-slate-100 text-brand-500 mb-6">
                        <Stethoscope size={40} />
                    </div>
                    <h1 className="text-5xl font-black text-slate-900 tracking-tighter mb-2">
                        Thyro<span className="text-brand-500">Lab</span>
                    </h1>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em]">Secure Specialist Portal</p>
                </div>
                ...
                <div className="bg-white p-10 rounded-[2.5rem] shadow-premium border border-slate-100">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full btn-primary h-16 text-base !rounded-2xl"
                        >
                            {loading ? (
                    ...
                    <div className="mt-8 text-center pt-8 border-t border-slate-50">
                        <p className="text-sm font-bold text-slate-500">
                            No credentials?{" "}
                            <Link to="/register" className="text-brand-500 hover:underline font-black ml-1 text-base">
                                Signup
                            </Link>
                        </p>
                    </div>
