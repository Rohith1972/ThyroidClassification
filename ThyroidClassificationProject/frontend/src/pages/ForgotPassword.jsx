        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50 relative overflow-hidden font-sans">
            ...
            >
                <div className="text-center relative">
                    <Link to="/login" className="absolute left-0 top-1/2 -translate-y-1/2 p-2 text-slate-400 hover:text-brand-500 hover:bg-white rounded-xl transition-all">
                        <ArrowLeft size={24} />
                    </Link>
                    <div className="inline-flex p-4 bg-white rounded-2xl shadow-premium border border-slate-100 text-amber-500 mb-6 mx-auto">
                        <ShieldCheck size={40} />
                    </div>
                    <h1 className="text-4xl font-black text-slate-900 tracking-tighter mb-2">
                        Recover <span className="text-amber-500">Access</span>
                    </h1>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] px-8">
                ...
                <div className="bg-white p-10 rounded-[2.5rem] shadow-premium border border-slate-100">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div className="space-y-2">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Specialist Email</label>
